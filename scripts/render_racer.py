...
views=[(.75,.40,920,470,4600*preview_scale),(math.pi/2,0,560,1010,4300*preview_scale),
       (0,.04,1390,1010,4600*preview_scale)]
...
d.text((150,1170),'FIXED DOORS  /  SWEPT REAR WING',font=font(22),fill=(82,96,111))
d.text((1120,1170),'CURVED ROOF  /  WIDER CABIN',font=font(22),fill=(82,96,111))
